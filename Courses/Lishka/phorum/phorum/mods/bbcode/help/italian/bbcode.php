<html>
  ...
  <body>
	...
	BBcode י l'acronimo in inglese che sta per Bulletin Board code.
    Sono dei codici che possono essere usati per formattare il
    testo. Questa pagina aiuta a capire come puף essere utilizzato
    ...
    <tt>
    [b]Questo testo י in grasseto[/b]<br/>
    [i]Questo testo י in italico[/i]<br/>
    [u]Questo testo י sottolineato[/u]<br/>
    [s]Questo testo ha una riga sopra[/s]<br/>
    [b][i]Questo testo[/i] י [s]vario[/s] e misto[/b]
    </tt><br/><br/>

    Il testo, una volta pubblicato, diventerב:<br/><br/>
    <b>Questo testo י in grasseto</b><br/>
    <i>Questo testo י in italico</i><br/>
    <u>Questo testo י sottolineato</u><br/>
    <strike>Questo testo ha una riga sopra</strike><br/>
    <b><i>Questo testo</i> י <strike>vario</strike> e misto</b>


    <h3>Posto in alto: [sup]...[/sup]<br/>Posto in basso: [sub]...[/sub] </h3>
    Inserendo questi codici, potete scrivere ponendo il testo in alto
    oppure in basso rispetto alla riga. Questo ad esempio puף tornare
    ...
    Questo codice puף essere utilizzato per dare una dimensione al testo intero o parziale.
...
Senza [code] prima e [/code] alla fine, questo testo apparirebbe completamente sconnesso cosם:
<br/><br/>
  _____  _                                <br/>
 |  __ \| |                               <br/>
...
<br/>
Ma inserendo [code] prima e [/code] alla fine, apparirב cosם:
<pre style="border: 1px solid #dde; background-color: #ffe; padding: 0px 0px 0px 10px">
 ...
 |_|    |_| |_|\___/|_|   \__,_|_| |_| |_|
    ...
    Se si vuole evidenziare del testo, si puף utilizzare questo codice. Si
    puף scegliere se si desidera includere il nome della persona da citare
    oppure no. Per esempio:<br/><br/>
    <tt>
    [quote]DubaiMania.NET י il miglior sito![/quote]<br/>
    ...
    Diventerב:<br/><br/>
    <blockquote class="bbcode">Quote:<div>DubaiMania.NET י il miglior sito!</div></blockquote>
    ...
    Per aggiungere una linea di separazione si puף usare [hr].
    Apparirב cosם:
    <hr>
    Questa funzione servirב soprattutto per aggiungere una struttura ad un lungo messaggio

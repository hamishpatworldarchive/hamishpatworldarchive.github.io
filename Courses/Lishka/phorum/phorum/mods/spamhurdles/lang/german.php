...
(
    ...
    "CaptchaExplain" => "Bitte gib den Code aus dem unten stehenden Bild in das Eingabefeld ein. Damit werden Bots, die versuchen dieses Formular automatisch auszufllen, geblockt.",
    ...
    "CaptchaWrongCode" => "Du hast einen falschen Code fr die Spamschutz-Abfrage eingegeben. Bitte versuche es noch einmal.",

    // Mathematical CAPTCHA
    "MaptchaTitle" => "Spamschutz:",
    "MaptchaExplain" => "Bitte gib die Lצsung der Matheaufgabe in das Eingabefeld ein. Damit werden Bots, die versuchen dieses Formular automatisch auszufllen, geblockt.",
    ...
    "MaptchaWrongAnswer" => "Du hast eine falsche Antwort fr die Spamschutz-Abfrage eingegeben. Bitte versuche es noch einmal.",
    ...
    "BlockError" => "Anti-Spam Software auf diesem Server hat deine Nachricht als vermutlichen Spam erkannt. Darum wurde die Nachricht geblockt. Wenn deine Nachricht kein Spam war, mצchten wir uns fr die Umstהnde, die durch das Blocken entstehen, entschuldigen. Solltest du mehrfach Probleme haben, dass deine Nachrichten geblockt werden, wende dich bitte an einen Administrator.<br/><br/><b>Hinweis</b>: Wenn JavaScript in deinem Browser ausgeschaltet ist er es gar nicht untersttzt, dann kצnnte dies der Grund sein, warum deine Nachrichten geblockt werden. Einige der verwendeten Anti-Spam Manahmen verwenden JavaScript.",
);
?>
